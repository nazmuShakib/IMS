...
function hasBlockingOverlay(): boolean {
  return Boolean(document.querySelector(
    'dialog[open], [data-scanner-blocking="true"], [role="alertdialog"], [role="dialog"][aria-modal="true"], [role="listbox"]',
  ));
}

/**
 * Captures keyboard-wedge scanner bursts while the page is active.
 *
