...
describe('Phase 3 role matrix', () => {
  const expected: Record<Role, readonly Capability[]> = {
    ...
    MANAGER: ['VIEW_STOCK', 'MOVE_STOCK', 'VIEW_COSTS', 'VIEW_REPORTS', 'MANAGE_CATALOG', 'CORRECT_STOCK', 'VIEW_RMA', 'CREATE_RMA', 'MANAGE_RMA', 'PRINT_LABELS', 'REPRINT_NON_STOCK_LABELS', 'CHECKOUT', 'RECORD_EARLIER_SALE', 'VIEW_INVOICES', 'RECORD_INVOICE_PAYMENT', 'MANAGE_CUSTOMERS', 'MANAGE_USED_DEVICES', 'VIEW_EXPENSES', 'MANAGE_EXPENSES', 'VIEW_EMI', 'RECORD_EMI_PAYMENT', 'APPROVE_EMI_SETTLEMENT'],
